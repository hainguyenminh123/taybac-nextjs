...
import { ChevronRight, Truck, CreditCard, StickyNote, Minus, Plus, Trash2 } from 'lucide-react';
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <input
                        ...
                        className="sr-only"
                      />
                      <CreditCard className={`w-5 h-5 ${paymentMethod === 'bank' ? 'text-primary' : 'text-muted-foreground'}`} />
                      <div>
